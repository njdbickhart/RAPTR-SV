 ...
 */
public class divet {
    // Attributes not needed in this version
    /*protected int end1; // the end of the first read
    protected int start2; // the end of the second read
    protected String chr2; // the chromosome position of the second read
    ...
    // Not used in this version. Commenting out until needed
    ...
    // Not used in this verison. commenting out until needed
